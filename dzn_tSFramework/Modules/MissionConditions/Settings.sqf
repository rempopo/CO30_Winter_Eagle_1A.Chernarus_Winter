...
MissionCondition1 = [ "WIN", {!alive TGT && {call fnc_CheckPlayersReturned} }, "Primary objective completed", 30 ];
MissionCondition2 = [ "FULL_WIN", { [ TRG_1, "east", "", "< 2"] call dzn_fnc_ccUnits && !alive TGT && {call fnc_CheckPlayersReturned} }, "All objectives completed", 30 ];
