...
"ВС РФ - Регулярные силы:<br /><br />Около 1-го взвода пехоты.<br />1 БТР-80.<br />Батарея 2С1 Гвоздика.<br />Артиллерийские наводчики.<br /><br />В настоящее время противник занят отражением наступления на н.п. Гришино, поэтому на фланге и в тылу осталась лишь пехота без тяжелого вооружения. Вражеские наблюдатели расположились на одной из башен старинного замка к востоку от нас, откуда открывается отличный вид на наши позиции. Основные силы противника патрулируют позиции вокруг батареи 2С1 и деревни Гвоздно, где располагается FARP. Сам FARP охраняет БТР-80 и несколько отделений пехоты. <br /><br />Разведка располагает данными о возможном пути подхода вражеских подкреплений (маркер ENEMY QRF), однако их количество остаётся неизвестным."
END
...
TOPIC("VI. Замечания:")
"Взрывчатка находится у гренадёров и стрелков. В ночное время выдается ночной прицел AN/PVS-4. Редеплои и доукомплекты согласно стандартным правилам."
END
